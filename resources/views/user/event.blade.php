    ...
    <div class="container mx-auto px-4 py-6">
        <form method="GET" action="{{ route('event.index') }}">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                @auth
                <a href="{{route('event.create')}}" class="text-white border-b-4 border-black w-full md:w-auto bg-budanes font-bold px-6 py-3 rounded-lg font-poppins hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2">
    ...
    <div class="container mx-auto px-4 pb-16">
        ...
        @else
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('event.show', $content->id) }}" class="block h-full">
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            ...
                            <div class="text-sm text-gray-500 font-poppins mb-2 flex items-center">
                            <i class="fas fa-calendar-alt mr-2 text-budanes"></i> Jadwal:
                             {{ \Carbon\Carbon::parse($content->jadwal)->translatedFormat('d F Y, H:i') }}
                            </div>
