...
@section('content')
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-gradient-to-r from-budanes to-dark py-8 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="text-center">
                    ...
                    <p class="font-poppins text-lg text-white opacity-90">Kelola level kontribusimu dan lihat ranking antar
                        kontrinutor berdasarkan setiap aktivitas yang telah kamu lakukan</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div id="quizCompletedModal"
                ...
                <div class="bg-white p-6 rounded-lg shadow-xl text-center max-w-sm mx-auto">
                    ...
                    <button id="closeModalBtn"
                        class="px-5 py-2 bg-budanes text-white rounded-lg hover:bg-budanes-dark transition-colors">
                        Oke
                    </button>
                </div>
            </div>
            ...
            <div
                class="bg-gradient-to-r from-dark to-budanes-darker rounded-xl shadow-lg overflow-hidden mb-8 p-6 text-white">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <a href="{{ route('badge.quiz') }}" id="start-quiz-btn"
                        class="px-6 py-3 bg-white text-budanes-darker font-bold rounded-lg hover:bg-gray-100 transition-colors flex items-center no-underline">
                        <i class="fas fa-play mr-2"></i> Kerjakan Kuis
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- Current Badge -->
                        <div
                            class="bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-6 text-center border border-gray-200">
                            <div
                                class="w-24 h-24 mx-auto bg-gradient-to-r {{ $badgeInfo['current']['color'] ?? 'from-gray-300 to-gray-400' }} rounded-full flex items-center justify-center text-white mb-4">
                                <i class="{{ $badgeInfo['current']['icon'] ?? 'fas fa-user' }} text-4xl"></i>
                            </div>
                            <h3 class="font-bold text-xl text-gray-800 mb-2">{{ $badgeInfo['current']['name'] ?? 'Abdi' }}
                            </h3>
                            <p class="text-gray-600 text-sm mb-3">{{ $badgeInfo['currentPoin'] }} Poin</p>
                            <span
                                class="inline-block px-3 py-1 bg-budanes-dark text-budanes-darker rounded-full text-xs font-bold">
                            ...
                            @if ($badgeInfo['next'])
                                <div class="mb-4">
                                    ...
                                    <p class="text-sm text-gray-600 mt-2">
                                        {{ number_format($badgeInfo['progress'], 1) }}% menuju
                                        {{ $badgeInfo['next']['name'] }}
                                    </p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="font-bold text-budanes-darker">{{ $userBadge->konten_approved ?? 0 }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                ...
                                <div class="mt-6 text-center">
                                    <button id="viewAwardsBtn"
                                        class="px-6 py-3 bg-budanes text-white font-bold rounded-lg hover:bg-budanes-dark transition-colors flex items-center mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        <!-- Abdi Badge -->
                        <div
                            class="bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-6 text-center border border-gray-200 hover:shadow-md transition-all">
                            <div
                                class="w-24 h-24 mx-auto bg-gradient-to-r from-gray-300 to-gray-400 rounded-full flex items-center justify-center text-white mb-4">
                                <i class="fas fa-user text-4xl"></i>
                            </div>
                            <h3 class="font-bold text-xl text-gray-800 mb-2">Abdi</h3>
                            <p class="text-gray-600 text-sm mb-3">0 - 100 Poin</p>
                            <span
                                class="inline-block px-3 py-1 bg-budanes-dark text-budanes-darker rounded-full text-xs font-bold">LEVEL
                                1</span>
                        </div>
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-6 text-center border border-gray-200 hover:shadow-md transition-all">
                            <div
                                class="w-24 h-24 mx-auto bg-gradient-to-r from-yellow-200 to-yellow-400 rounded-full flex items-center justify-center text-white mb-4">
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-6 text-center border border-gray-200 hover:shadow-md transition-all">
                            <div
                                class="w-24 h-24 mx-auto bg-gradient-to-r from-blue-300 to-blue-500 rounded-full flex items-center justify-center text-white mb-4">
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-6 text-center border border-gray-200 hover:shadow-md transition-all">
                            <div
                                class="w-24 h-24 mx-auto bg-gradient-to-r from-purple-300 to-purple-500 rounded-full flex items-center justify-center text-white mb-4">
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-100 to-gray-50 rounded-xl p-6 text-center border border-gray-200 hover:shadow-md transition-all">
                            <div
                                class="w-24 h-24 mx-auto bg-gradient-to-r from-red-400 to-budanes-darker rounded-full flex items-center justify-center text-white mb-4">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-200">
                        @forelse($topUsers as $index => $user)
                            <div
                                class="p-4 hover:bg-gray-50 transition-colors {{ Auth::id() == $user->akun_id ? 'bg-budanes-light border-l-4 border-budanes' : '' }}">
                                <div class="flex items-center">
                                    <div
                                        class="w-10 h-10 rounded-full {{ Auth::id() == $user->akun_id ? 'bg-budanes-darker' : 'bg-budanes' }} text-white flex items-center justify-center font-bold mr-4">
                                        {{ $index + 1 }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p class="font-medium text-gray-800 truncate">
                                            <span
                                                class="text-xs bg-budanes-darker text-white px-2 py-1 rounded-full ml-2">Anda</span>
                                        </p>
                                    ...
                                    <div class="ml-4">
                                        <span
                                            class="px-3 py-1 bg-budanes-dark text-budanes-darker rounded-full text-sm font-bold">
                                            {{ $user->poin ?? 0 }} Poin
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="divide-y divide-gray-200">
                        @forelse($topContents as $index => $content)
                            <div class="p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex items-center">
                                    <div
                                        class="w-10 h-10 rounded-full bg-budanes text-white flex items-center justify-center font-bold mr-4">
                                        {{ $index + 1 }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-500 flex items-center">
                                            ...
                                            <span
                                                class="ml-2 text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">Approved</span>
                                        </p>
                                    </div>
                                    <div class="ml-4">
                                        <span
                                            class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium capitalize">
                                            {{ $content->asal }}
                                        </span>
                                    </div>
                                </div>
    ...
    <div id="awardsModal" class="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center hidden z-50">
        <div class="bg-white p-8 rounded-xl shadow-xl max-w-md w-full mx-4">
            <div class="text-center">
                <!-- Badge Icon -->
                <div
                    class="w-32 h-32 mx-auto bg-gradient-to-r {{ $badgeInfo['current']['color'] ?? 'from-gray-300 to-gray-400' }} rounded-full flex items-center justify-center text-white mb-6">
                    <i class="{{ $badgeInfo['current']['icon'] ?? 'fas fa-user' }} text-6xl"></i>
                </div>

                <h3 class="text-3xl font-bold text-gray-800 mb-2">Selamat!</h3>
                <p class="text-xl text-budanes-darker font-medium mb-4"> telah mencapai</p>
                ...
                <button id="closeAwardsModalBtn"
                    class="px-6 py-2 bg-budanes text-white rounded-lg hover:bg-budanes-dark transition-colors mb-4">
                    Tutup
                </button>
            ...
            @if (session('quiz_submission_status'))
                ...
                if (status === 'success') {
                    ...
                    if (score >= 80) {
                        ...
                        resultImage =
                        'https://i.pinimg.com/originals/ab/4b/8e/ab4b8e151241dd9e30ac691a7bdd1287.gif';
                    } else if (score >= 60) {
                        resultMessage = 'Bagus! Pengetahuan Anda tentang budaya Indonesia cukup baik.';
                        resultImage =
                        'https://i.pinimg.com/originals/8c/8c/97/8c8c97dacf1e7936bb86faff609ebf3c.gif';
                    } else {
                        resultMessage = 'Ish ish ish! Pelajari lagi budaya Indonesia dan coba lagi.';
                        resultImage =
                        'https://i.pinimg.com/originals/c0/8a/95/c08a953a7b7e293c9fa5b68abb6d135f.gif';
                    }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            downloadPdfBtn.addEventListener('click', function() {
                ...
                html2canvas(modalContent, {
                    ...
                    pdf.text('Sertifikat Badge Penghargaan', pageWidth / 2, margin + 5, {
                        align: 'center'
                    });
                    ...
                    if (footerY < pageHeight - 15) { // Pastikan footer muat
                        ...
                        pdf.text('Sistem Badge Level - Budaya Indonesia', pageWidth / 2, footerY +
                            5, {
                                align: 'center'
                            });
                    }
