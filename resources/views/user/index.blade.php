...
@section('content')
    ...
    <section class="relative h-screen max-h-[800px] overflow-hidden">
            ...
            <div class="container mx-auto px-4 text-white">
                <div class="max-w-2xl">
                    ...
                    <p x-text="slides[currentSlide].subtitle"
                        class="text-xl md:text-2xl mb-8 animate-fade-in animate-delay-100"></p>
        ...
        <button @click="prevSlide"
            class="absolute left-4 top-1/2 z-30 -translate-y-1/2 bg-white/30 text-white p-3 rounded-full hover:bg-white/50 transition">
            <i class="fas fa-chevron-left"></i>
        </button>
        <button @click="nextSlide"
            class="absolute right-4 top-1/2 z-30 -translate-y-1/2 bg-white/30 text-white p-3 rounded-full hover:bg-white/50 transition">
        ...
        <div class="absolute bottom-8 left-1/2 z-30 -translate-x-1/2 flex space-x-2">
            <template x-for="(slide, index) in slides" :key="index">
                <button @click="currentSlide = index" class="w-3 h-3 rounded-full transition duration-300"
                    :class="{ 'bg-budanes w-6': currentSlide === index, 'bg-white/50': currentSlide !== index }"></button>
            </template>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4 font-montserrat">10 </h2>
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4 font-montserrat">Tujuan Wisata</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Temukan berbagai fitur menarik yang membantu Anda
                    mengenal dan melestarikan budaya Indonesia</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4 font-montserrat">Kenali Fitur <span
                        class="border-b-4 border-black text-white rounded-lg py-2 px-4 bg-budanes">Dewa Arjasa</span></h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Temukan berbagai fitur menarik yang membantu Anda
                    mengenal dan melestarikan budaya Indonesia</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- Feature 1 -->
                <div
                    class="bg-white rounded-lg shadow-lg overflow-hidden border-b-4 border-budanes transform hover:-translate-y-2 transition duration-300">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Jelajahi berbagai konten budaya dari seluruh nusantara dalam bentuk konten,
                            foto, dan video.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">Temukan dan ikuti berbagai event budaya terdekat untuk pengalaman langsung.
                        </p>
                    </div>
                </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4 font-montserrat">Tour Package</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Temukan budaya-budaya yang sedang populer di kalangan
                    pengguna</p>
            </div>
                        ...
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden border-b-4 border-budanes">
                            ...
                            <div class="p-6">
                                <div class="flex items-center mb-2">
                                    <span
                                        class="px-2 py-1 bg-budanes-dark text-dark text-xs font-bold rounded">{{ $content->kategori }}</span>
                                ...
                                <a href="{{ route('kontenbudaya.show', $content->id) }}"
                                    class="text-budanes-darker font-semibold hover:underline flex items-center">
            ...
            <div class="text-center mt-12">
                <a href="{{ route('konten.index') }}"
                    class="inline-block px-8 py-3 bg-budanes text-white font-bold rounded-lg hover:bg-darker transition duration-300">
            ...
            @if ($upcomingEvents->count() > 0)
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    @foreach ($upcomingEvents as $event)
                        <div
                            class="bg-white rounded-lg shadow-lg overflow-hidden border-b-4 border-budanes flex flex-col md:flex-row">
                            <div class="md:w-1/3">
                                @if ($event->thumbnail)
                            ...
                            <div class="p-6 md:w-2/3">
                                <div class="flex items-center mb-2">
                                    <span
                                        class="px-2 py-1 bg-budanes-dark text-dark text-xs font-bold rounded">{{ $event->tempat }}</span>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ route('event.show', $event->id) }}"
                                        class="text-sm font-semibold text-dark hover:underline flex items-center">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg border-b-4 border-budanes">
                    ...
                    <p class="text-gray-600">"BudayaNesia membantu saya menemukan berbagai event budaya yang tidak saya
                        ketahui sebelumnya. Sangat informatif!"</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg border-b-4 border-budanes">
                    ...
                    <p class="text-gray-600">"Saya suka fitur badge level-nya, membuat saya termotivasi untuk terus belajar
                        tentang budaya Indonesia."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg border-b-4 border-budanes">
                    ...
                    <p class="text-gray-600">"Konten-konten budaya di sini sangat lengkap dan mudah dipahami. Cocok untuk
                        semua usia!"</p>
                </div>
            </div>
        </div>
    ...
    @else
        <section class="py-16 bg-budanes text-white">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-xl mb-8 max-w-2xl mx-auto">Bergabunglah dengan ribuan orang yang telah menjelajahi kekayaan
                    budaya Indonesia melalui BudayaNesia</p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="{{ 'login' }}"
                        class="px-8 py-3 bg-budanes-dark text-dark font-bold rounded-lg hover:text-white hover:bg-budanes-darker transition duration-300">
                        Daftar Sekarang
                    </a>
                    <a href="/about"
                        class="px-8 py-3 border-2 border-white text-white font-bold rounded-lg hover:text-black hover:bg-white transition duration-300">
