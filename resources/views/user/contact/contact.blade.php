    ...
    <div class="container mx-auto px-4 max-w-screen-xl">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Ada pertanyaan, saran, atau ingin berkolaborasi? Jangan ragu untuk menghubungi kami. Tim kami siap membantu petualangan Anda di Arjasa!
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg" data-aos="fade-right" data-aos-delay="100">
                <h3 class="text-2xl font-bold text-gray-800 mb-6 font-montserrat">Kirim Pesan kepada Kami</h3>
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="subject" name="subject"
                            class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-400 focus:border-blue-400 sm:text-sm"
                            placeholder="Contoh: Pertanyaan tentang paket wisata">
                    </div>
                    <div>
            ...
            <div class="space-y-10">
                <div class="bg-white p-8 rounded-xl shadow-lg" data-aos="fade-left" data-aos-delay="200">
                    <h3 class="text-2xl font-bold text-gray-800 mb-6 font-montserrat">Informasi Kontak</h3>
                    <div class="space-y-4 text-gray-700">
                        <div class="flex items-start">
                            <i class="fas fa-map-marker-alt text-red-400 mr-3 mt-1 text-lg"></i>
                            <span>Alamat: Jl. Rengganis No.1, Bendelan, Arjasa, Kabupaten Jember, Jawa Timur 68121</span>
                        </div>
                        <div class="flex items-start">
                            <i class="fab fa-whatsapp text-blue-400 mr-3 mt-1 text-lg"></i>
                            <div>
                                <p>WhatsApp:</p>
                                <p><a href="https://wa.me/6285185196301" target="_blank" class="text-blue-600 hover:underline">0851 8519 6301</a> (Admin Desa Wisata Adat Arjasa)</p>
                                <p><a href="https://wa.me/6282123577199" target="_blank" class="text-blue-600 hover:underline">0821 2357 7199</a> (Pokdarwis Desa Wisata Adat Arjasa)</p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <i class="fas fa-envelope text-blue-400 mr-3 text-lg"></i>
                            <span>Email: <a href="mailto:desaadatarijasa@gmail.com" class="text-blue-600 hover:underline">desaadatarijasa@gmail.com</a></span>
                        </div>
                    </div>
                    <div class="mt-8">
                        <h4 class="text-lg font-semibold text-gray-800 mb-3">Ikuti Kami</h4>
                        <div class="flex space-x-4">
                            ...
                            <a href="https://twitter.com/AdatArjasa83936" target="_blank" class="bg-white text-blue-400 rounded-full w-9 h-9 flex items-center justify-center hover:bg-blue-200 transition">
                ...
                {{-- Bagian Peta (Opsional) --}}
                <div class="bg-white p-4 rounded-xl shadow-lg overflow-hidden" data-aos="fade-left" data-aos-delay="300">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 font-montserrat">Lokasi Kami</h3>
                    <div class="w-full h-64 rounded-lg overflow-hidden border border-gray-300">
                        {{-- Embed Google Maps untuk Arjasa, Jember --}}
                        <iframe
